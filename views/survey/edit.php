...
<div class="page-header">
    <h2><font color="red">แก้ไขการสำรวจ ADL ของ <?php echo $person->pname." ".$person->fname." ".$person->lname ;?></font></h2>
</div>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-5">
            ...
            <?= Html::a(' กลับหน้ารายชื่อคัดกรอง ADL', ['survey/list','id'=>$person->cid], ['class' => 'btn btn-warning glyphicon glyphicon-triangle-left']) ?>
