...
class SurveyList extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['survey_staff_id','s_d1','s_d2','s_d3','s_d4','s_d5','s_d6','s_d7','s_d8','s_d9', 's_d10'], 'required'],
            [[ 's_d1', 's_d2', 's_d3', 's_d4', 's_d5', 's_d6', 's_d7', 's_d8', 's_d9', 's_d10', 's_sum'], 'integer'],
            [['create_date','create_by','survey_staff_id'], 'safe'],
            [['cid'], 'string', 'max' => 13],
            [['hcode'], 'string', 'max' => 5],
